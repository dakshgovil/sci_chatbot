...
class ChatbotAssistant:
    ...
    def save_model(self, model_path, dimensions_path):
        if not self.model:
            raise RuntimeError("Model not trained. Train before saving.")
    ...
    def load_model(self, model_path, dimensions_path):
        ...
        # Reconstruct vocabulary and intents from saved data
        self.vocabulary = dimensions.get("vocabulary", [])
        self.intents = dimensions.get("intents", [])
...
if __name__ == "__main__":
    ...
    try:
        ...
        # Save model with additional context
        print("\nSaving model...")
